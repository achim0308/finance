...
class TransactionForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        for field in ['cashflow', 'expense', 'tax']:
            if self.cleaned_data.get('security').currency != self.cleaned_data.get(field).currency.code:
                self.add_error(field, ValidationError("Currency does not match"))
